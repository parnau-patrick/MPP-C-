...
namespace ConcursClient.controller
{
    public partial class LoginForm : Form
    {
        ...
        private void btnLogin_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                User user = serviceProxy.Login(username, password);
                if (user != null)
                {
                    log.Info("Login successful for user: " + username);
                    
                    // Show main form
                    MainForm mainForm = new MainForm(serviceProxy, user);
        ...
        private void lnkSignUp_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            SignUpForm signUpForm = new SignUpForm(serviceProxy);
            signUpForm.SignUpSuccessful += SignUpForm_SignUpSuccessful;
            signUpForm.ShowDialog();
        }

        private void SignUpForm_SignUpSuccessful(object sender, SignUpForm.UserEventArgs e)
        {
