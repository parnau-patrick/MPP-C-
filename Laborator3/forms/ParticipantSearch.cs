...
namespace Laborator3
{
    public partial class ParticipantSearchForm : Form
    {
        ...
        public ParticipantSearchForm(EventService eventService, InscriereService inscriereService)
        {
            InitializeComponent();
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                var participants = inscriereService.FindAllParticipantsByEvent(selectedEvent.Id);
                ...
                foreach (var participant in participants)
                {
                    ...
                    // Get number of events for this participant
                    int eventCount = inscriereService.CountEventsForParticipant(participant.Id);
                    item.SubItems.Add(eventCount.ToString());
                    
                    item.Tag = participant; // Store the participant object for later use
