    ...
    public class ConcursServicesJsonProxy
    {
        ...
        public User Login(string username, string password)
        {
            ...
            try
            {
                ...
                else if (response.Data is JObject)
                {
                    ...
                    user = userObj.ToObject<User>(JsonSerializer.Create(JsonSerializerUtils.SerializerSettings));
                }
                else
                {
                    var json = JsonConvert.SerializeObject(response.Data, JsonSerializerUtils.SerializerSettings);
                    user = JsonConvert.DeserializeObject<User>(json, JsonSerializerUtils.SerializerSettings);
                }
        ...
        public List<Event> GetAllEvents()
        {
            ...
            try
            {
                ...
                {
                    var json = JsonConvert.SerializeObject(response.Data, JsonSerializerUtils.SerializerSettings);
                    events = JsonConvert.DeserializeObject<List<Event>>(json, JsonSerializerUtils.SerializerSettings);
                }
        ...
        public List<EventDTO> GetAllEventsWithParticipantCounts()
        {
            ...
            try
            {
                ...
                {
                    var json = JsonConvert.SerializeObject(response.Data, JsonSerializerUtils.SerializerSettings);
                    eventDtos = JsonConvert.DeserializeObject<List<EventDTO>>(json, JsonSerializerUtils.SerializerSettings);
                }
        ...
        public List<ParticipantEventDTO> GetParticipantsByEvent(int eventId)
        {
            ...
            try
            {
                ...
                {
                    var json = JsonConvert.SerializeObject(response.Data, JsonSerializerUtils.SerializerSettings);
                    participantDtos = JsonConvert.DeserializeObject<List<ParticipantEventDTO>>(json, JsonSerializerUtils.SerializerSettings);
                }
        ...
        public List<Participant> GetAllParticipants()
        {
            ...
            try
            {
                ...
                {
                    var json = JsonConvert.SerializeObject(response.Data, JsonSerializerUtils.SerializerSettings);
                    participants = JsonConvert.DeserializeObject<List<Participant>>(json, JsonSerializerUtils.SerializerSettings);
                }
